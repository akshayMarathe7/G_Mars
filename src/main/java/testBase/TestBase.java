...
public class TestBase 
{
	...
	
	{
		...
		System.setProperty("webdriver.ie.driver", "E:\\Soft\\Selenium\\Drivers\\IEDriver\\IEDriverServer.exe");
		driver=new InternetExplorerDriver();
	}

	public void Browser_Opera()
	{
		System.setProperty("webdriver.opera.driver", "E:\\Soft\\Selenium\\Drivers\\OperaDriver\\operadriver_win64\\operadriver.exe");
